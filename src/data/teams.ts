...
export const teams: Team[] = [
    ...
    campaigns: [
      ...
      },
      {
        ...
        specs: [
          ...
          { label: "Line sensors", value: "OSRAM SFH-4656 IR LED + Kingbright AP2012P3C", },
  ...
  },
  {
    ...
    campaigns: [
      {
        id: "team-2-robocup-open-2027",
        discipline: "rcj-soccer-open",
        years: "2027",
        status: "in-development",
        tagline: "",
        summary: "The second build, for the 2027 robocup open competition.",
        specs: [],
        docs: [],
        gallery: [],
      },
      {
        id: "team-2-robocup-infrared-2026",
        discipline: "rcj-soccer-infra",
        years: "2026",
        status: "competing",
        tagline: "The first build.",
        summary: "This team's first competition year. Inspired by the prevoius team, it featured a Raspberry Pi 5 for vision and logic, two wide angle Arducam IMX708 cameras (front and back) for computing the position on the field, a Teensy 4.1 handling line sensors and motors, and a fully multiprocess software stack.",
        specs: [
          { label: "Main processing unit", value: "Raspberry Pi 5" },
          { label: "Secondary MCU", value: "Teensy 4.1 (line sensors, motors)" },
          { label: "Front Camera", value: "Arducam IMX708, 120° FOV, 12MP" },
          { label: "IMU", value: "Adafruit BNO055" },
          { label: "Motors", value: "Pololu 37D Metal Gearmotors" },
          { label: "Motor drivers", value: "Pololu Dual G2 Motor Drivers" },
          { label: "Omni wheels", value: "self-made" },
        ],
        codeRepo: "https://github.com/anton2026gamca/lnx-infrabot",
        hardwareRepo: "https://github.com/anton2026gamca/lnx-infrabot/tree/main/hardware",
        docs: [
          { title: "Poster — RoboCup 2026, Vienna", href: "/content/team-2/docs/LNX_Robots_poster.pdf", kind: "poster", year: 2026 },
        ],
        gallery: [],
      },
    ],
